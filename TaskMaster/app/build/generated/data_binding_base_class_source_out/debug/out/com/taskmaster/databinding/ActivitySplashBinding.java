...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull LottieAnimationView splashLottie, @NonNull TextView tvAppName,
      @NonNull TextView tvTagline) {
    this.rootView = rootView;
    this.splashLottie = splashLottie;
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LottieAnimationView splashLottie = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, splashLottie, tvAppName,
          tvTagline);
    }
