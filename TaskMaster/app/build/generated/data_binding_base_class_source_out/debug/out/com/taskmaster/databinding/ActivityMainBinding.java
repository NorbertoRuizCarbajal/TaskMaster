...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull LottieAnimationView loaderLottie, @NonNull ConstraintLayout loaderView,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.loaderView;
      ConstraintLayout loaderView = ViewBindings.findChildViewById(rootView, id);
      if (loaderView == null) {
        break missingId;
      }
